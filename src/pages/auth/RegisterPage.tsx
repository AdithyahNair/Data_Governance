...
import { ArrowRight, ArrowLeft, Bell, Bookmark, Share2, Zap } from "lucide-react";
...
export default function RegisterPage() {
  ...
  const headlines = [
    ...
    },
    {
      ...
      subtitle: "Insights from governing complex markets can inform AI regulation using partitions, transparency, control points and accountability",
    ...
    },
    {
      ...
      subtitle: "Precision and compliance are the cornerstones of responsible AI development, ensuring transparency, control, and accountability. - Arun Prasad",
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-1/2 flex items-center justify-center p-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-xs text-gray-500 mt-2">
            By clicking "Sign up with Google" I agree to the <a href="/terms" className="text-blue-600 hover:underline">Terms of Service</a>, acknowledge <a href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</a>, and consent to receive updates, special offers, and promotional emails. I understand that I can opt out at any time.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-2 mt-6">
              ...
              <div className="grid gap-1.5 leading-none">
                ...
                >
                  I want to receive updates, special offers, and promotional emails. I understand that I can opt out at any time.
                </label>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-2 mt-4">
              ...
              <div className="grid gap-1.5 leading-none">
                <label
                  ...
                  className="text-sm font-medium leading-none text-gray-700"
                >
                  I agree to the <a href="/terms" className="text-blue-600 hover:underline">Terms of Service</a> and acknowledge <a href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</a>
                </label>
              </div>
            </div>
      ...
      <div className="w-1/2 flex items-center justify-center">
        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 p-6 z-20">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white font-bold text-lg tracking-wide">AI PULSE</span>
              </div>
              <motion.div 
          ...
          <div className="absolute top-20 left-6 z-10 max-w-sm">
            ...
            >
              ...
              <p className="text-white/80 text-sm mb-5">
                Stay ahead with critical developments in AI regulation, ethics, and policy frameworks worldwide.
              </p>
              <motion.button 
          ...
          <div className="absolute inset-0 flex items-center z-10" style={{ marginLeft: "55px" }}>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.03, boxShadow: "0 0 30px rgba(109, 40, 217, 0.4)" }}
                  >
          ...
          <div className="absolute bottom-0 left-0 right-0 h-10 bg-black/30 backdrop-blur-md flex items-center justify-center text-white/60 text-xs z-10">
            ...
            <span>Data sources: Global AI Policy Institute, UN Tech Council, EU Commission</span>
            <span className="mx-2">•</span>
